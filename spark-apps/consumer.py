...
spark = (
    ...
    .config("spark.hadoop.fs.s3a.access.key", "MIN")
...
"""
"""
docker exec -it spark-master /opt/spark/bin/spark-submit --master spark://spark-master:7077 --conf spark.jars=/opt/spark/jars --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.4.2,io.delta:delta-core_2.12:2.4.0,org.apache.hadoop:hadoop-aws:3.3.4 --conf spark.sql.extensions=io.delta.sql.DeltaSparkSessionExtension --conf spark.sql.catalog.spark_catalog=org.apache.spark.sql.delta.catalog.DeltaCatalog /opt/spark-apps/stream_station_status.py -d
"""